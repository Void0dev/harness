...
import { parseIssueModelId, parseIssueProviderId, parseParentSessionId } from "../src/opencode.js";
...
test("uses the Issue model marker and falls back to the configured model", () => {
  ...
  assert.equal(parseIssueProviderId("<!-- opencode-harness-parent: ses_parent_12345678 -->\n<!-- opencode-harness-provider: void-image -->"), "void-image");
});
